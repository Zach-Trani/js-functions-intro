...
const { divideByThree, averageOfTwo, averageOfAny, doubler, combineArrays, wordWithinArray, echo, fizzBuzz, hello, goodbye, isFive, isOdd, aCounter, addThree } = require("../problems");
